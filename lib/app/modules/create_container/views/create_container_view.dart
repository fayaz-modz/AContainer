          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => Column(
                  children: [
                    for (int i = 0; i < controller.volumes.length; i++)
                      Padding(
                        padding: const EdgeInsets.only(bottom: 8.0),
                        child: Row(
                          children: [
                            Expanded(
                              child: TextFormField(
                                initialValue: controller.volumes[i]['host'],
                                decoration: const InputDecoration(
                                  labelText: 'Host Path',
                                  border: OutlineInputBorder(),
                                  isDense: true,
                                ...
                                onChanged: (value) =>
                                    controller.updateVolumeHost(i, value),
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                              child: TextFormField(
                                initialValue:
                                    controller.volumes[i]['container'],
                                decoration: const InputDecoration(
                                ...
                                onChanged: (value) =>
                                    controller.updateVolumeContainer(i, value),
                              ),
                            ),
                            const SizedBox(width: 8),
                            IconButton(
                              ...
                              onPressed: () => controller.removeVolume(i),
                              tooltip: 'Remove',
                            ),
                          ],
                        ),
              ...
              Obx(
                () => FilledButton(
                  ...
                  child: controller.isLoading.value
                      ...
                      : Text(
                          'Create ${type == ContainerType.service ? 'Service' : 'VM'} Container',
  ...
  Widget _buildAdvancedSettings(ContainerType type, BuildContext context) {
    return Column(
      ...
      children: [
        ...
        // Boolean flags (TTY and Privileged are enabled by default for VM type)
        if (type == ContainerType.vm) ...[
          // VM Container - Show enabled indicators in columns
          Container(
            decoration: BoxDecoration(
            ...
            child: Column(
              children: [
                _buildVMFeatureCard(
                  ...
                  title: 'TTY Enabled',
                  description:
                      'Allocate TTY devices for proper init system support',
                  color: Colors.green,
                ),
                Divider(height: 1, color: Colors.green.shade200),
                _buildVMFeatureCard(
                  icon: Icons.security,
                  title: 'Privileged Enabled',
                  description:
                      'Full system capabilities for complete container access',
                  color: Colors.green,
                ),
              ],
            ),
          ...
          // Service Container - Show interactive checkboxes
          Container(
            decoration: BoxDecoration(
        ...
        Obx(
          () => CheckboxListTile(
            ...
            onChanged: (value) => controller.noOverlayfs.value = value ?? false,
            contentPadding: EdgeInsets.zero,
          ),
        ),
